...
def saveDoc():
    """Save the written text to a chosen folder"""
    global textarea
...
savebtn.config(font=('arial', 10, 'bold'), bg="DodgerBlue2", fg="white")

fontbtn = Menubutton(root, text="Font")
fontbtn.config(font=('arial', 10, 'bold'), bg="DodgerBlue2", fg="white")
...
boldbtn.config(font=('arial', 10, 'bold'), bg="DodgerBlue2", fg="white")
